...
node_modules/.bin/browserify lib/aiplayoff.ts --exclude ws --exclude child_process --exclude "colors/safe" --ignore-missing --dg=false  -p [ tsify --noImplictAny ] --debug > src/aiplayoff.js
